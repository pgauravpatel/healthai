...
export default function Seo({
  ...
  const siteUrl = 'https://healthreportscan.info'
...
export const organizationSchema = {
  ...
  "@type": "Organization",
  "name": "Health Scan",
  "url": "https://healthreportscan.info",
  "logo": "https://healthreportscan.info/favicon.svg",
...
export const getArticleSchema = (article) => ({
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://healthreportscan.info/favicon.svg"
    }
  },
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": `https://healthreportscan.info/blogs/${article.slug}`
  }
})
